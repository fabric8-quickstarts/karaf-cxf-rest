package io.fabric8.tests.integration.support;
...
import static io.fabric8.tests.integration.support.KubernetesTestUtil.failNotDeployed;
import static io.fabric8.tests.integration.support.KubernetesTestUtil.isNotNullOrEmpty;
import static io.fabric8.tests.integration.support.KubernetesTestUtil.isNullOrEmpty;
...
public class KubernetesTestDeployer {
    ...
    private static final Predicate<Pod> podStatusPhasePredicate = pod -> pod.getStatus().getPhase().equals("Succeeded")
